...
var PaginationDataProvider = /*#__PURE__*/function (_Provider) {
  ...
  _createClass(PaginationDataProvider, [{
    ...
    function UNSAFE_componentWillReceiveProps(nextProps) {
      ...
      var pageStartIndex = typeof nextProps.pagination.options.pageStartIndex !== 'undefined' ? nextProps.pagination.options.pageStartIndex : _const["default"].PAGE_START_INDEX; // user should align the page when the page is not fit to the data size when remote enable
